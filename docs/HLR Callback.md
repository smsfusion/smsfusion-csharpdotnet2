# IO.Swagger.Model.HLRCallback
## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Id** | **string** | Unique ID for response | [optional] [default to null]
**Msisdn** | **long?** | The MSISDN of the number queried | [optional] [default to null]
...
**_Operator** | **string** | The operator attached to the MSISDN | [optional] [default to null]
**Mccmnc** | **int?** | MCC and MNC of MSDISDN | [optional] [default to null]
...
**Cost** | **float?** | Cost of the response | [optional] [default to null]
